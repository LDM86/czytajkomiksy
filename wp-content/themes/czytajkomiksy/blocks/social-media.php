...
$sm__display = get_field('sm__display');
$sm__fans = get_field('sm__fans');

$facebook = get_field('sm__facebook', 'option');
$facebook__fans = get_field('sm__facebook_fans', 'option');
$instagram = get_field('sm__instagram', 'option');
$instagram__fans = get_field('sm__instagram_fans', 'option');
$youtube = get_field('sm__youtube', 'option');
$youtube__fans = get_field('sm__youtube_fans', 'option');
$twitch = get_field('sm__twitch', 'option');
$twitch__fans = get_field('sm__twitch_fans', 'option');
$twitter = get_field('sm__twitter', 'option');
$twitter__fans = get_field('sm__twitter_fans', 'option');
$linkedin = get_field('sm__linkedin', 'option');
$fbgroup = get_field('sm__fbgroup', 'option');
$tiktok = get_field('sm__tiktok', 'option');
$tiktok__fans = get_field('sm__tiktok_fans', 'option');

if ($sm__display == 'two-column') :
    $sm__class = ' sm__content--two';
elseif ($sm__display == 'one-column') :
    $sm__class = ' sm__content--one';
endif;

if ($sm__display == 'one-column') :
    $f = 'f';
endif;
?>


<?php if (($sm__display == 'two-column') || ($sm__display == 'one-column')) : ?>
    <div class="sm">
        <div class="sm__content<?php echo $sm__class; ?>">
            <?php if ($facebook) : ?>
                <a class="sm__box sm__box--facebook" href="<?php echo esc_url($facebook); ?>">
                    ...
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($facebook__fans);?><?php if ($f) : ?> fanów<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($instagram) : ?>
                <a class="sm__box sm__box--instagram" href="<?php echo esc_url($instagram); ?>"><svg fill="#405de6" width="25" height="25" version="1.1" id="lni_lni-instagram-original" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
                        <g>
                    ...
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($instagram__fans);?><?php if ($f) : ?> obserwujących<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($youtube) : ?>
                <a class="sm__box sm__box--youtube" href="<?php echo esc_url($youtube); ?>">
                    ...
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($youtube__fans);?><?php if ($f) : ?> subskrybentów<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($twitch) : ?>
                <a class="sm__box sm__box--twitch" href="<?php echo esc_url($twitch); ?>">
                ...
                L56,36.1z M46.8,17.2v16.2h-5.5V17.2H46.8z M32,17.2v16.2h-5.5V17.2H32z" />
                    ...
                    <span class="sm__name">Twitch</span>
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($twitch__fans);?><?php if ($f) : ?> subskrybentów<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($twitter) : ?>
                <a class="sm__box sm__box--twitter" href="<?php echo esc_url($twitter); ?>"><svg fill="#00aeef" width="25" height="25" version="1.1" id="lni_lni-twitter-original" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
                    ...
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($twitter__fans);?><?php if ($f) : ?> obserwujących<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($tiktok) : ?>
                <a class="sm__box sm__box--tiktok" href="<?php echo esc_url($tiktok); ?>">
                    ...
                    <?php if (($f) && ($sm__fans == 'yes')) : ?>-<?php endif;?>
                    <?php if ($sm__fans == 'yes') : ?><span class="sm__fans"><?php echo wp_kses_post($tiktok__fans);?><?php if ($f) : ?> obserwujących<?php endif;?></span><?php endif; ?>
                </a>
            <?php endif; ?>
            <?php if ($linkedin) : ?>
                <a class="sm__box sm__box--linkedin" href="<?php echo esc_url($linkedin); ?>"><svg fill="#0077b5" width="25" height="25" version="1.1" id="lni_lni-linkedin-original" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
            ...
            <?php endif; ?>
            <?php if ($fbgroup) : ?>
                <a class="sm__box sm__box--fbgroup" href="<?php echo esc_url($fbgroup); ?>">
                    <svg fill="#1877f2" width="30" height="30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
                        <g>
                    ...
                    <span class="sm__name">Grupa FB</span>
                </a>
            <?php endif; ?>

        </div>
    </div>
<?php elseif ($sm__display == 'icons') : ?>
